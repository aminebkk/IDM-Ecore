...
public class RobotSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RobotPackage.RFUNCTION: {
			RFunction rFunction = (RFunction) theEObject;
			T result = caseRFunction(rFunction);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>RFunction</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>RFunction</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRFunction(RFunction object) {
		return null;
	}
