 ...
 * </p>
 * <ul>
 *   <li>{@link robot.impl.BinaryExpressionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BinaryExpressionImpl extends ExpressionImpl implements BinaryExpression {
	...
	protected EClass eStaticClass() {
		return RobotPackage.Literals.BINARY_EXPRESSION;
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectContainmentEList<Expression>(Expression.class, this,
					RobotPackage.BINARY_EXPRESSION__EXPRESSION);
		}
		return expression;
	}
