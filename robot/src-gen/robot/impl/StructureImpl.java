 ...
 * </p>
 * <ul>
 *   <li>{@link robot.impl.StructureImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetCondition(BooleanExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotPackage.STRUCTURE__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotPackage.STRUCTURE__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotPackage.STRUCTURE__CONDITION, newCondition,
					newCondition));
	}
